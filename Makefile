...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Jun 18 18:26:15 2016
# Project:  lights.pro
# Template: app
...
SOURCES       = main.cpp \
		main_window.cpp \
		model.cpp \
		frame_widget.cpp moc_main_window.cpp \
		qrc_app.cpp
OBJECTS       = main.o \
		main_window.o \
		model.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lights1.0.0/ && $(COPY_FILE) --parents main_window.h model.h frame_widget.h .tmp/lights1.0.0/ && $(COPY_FILE) --parents app.qrc .tmp/lights1.0.0/ && $(COPY_FILE) --parents main.cpp main_window.cpp model.cpp frame_widget.cpp .tmp/lights1.0.0/ && (cd `dirname .tmp/lights1.0.0` && $(TAR) lights1.0.0.tar lights1.0.0 && $(COMPRESS) lights1.0.0.tar) && $(MOVE) `dirname .tmp/lights1.0.0`/lights1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lights1.0.0
