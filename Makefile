...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Jun 12 18:35:09 2016
# Project:  lights.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lights1.0.0/ && $(COPY_FILE) --parents main_window.h .tmp/lights1.0.0/ && $(COPY_FILE) --parents app.qrc .tmp/lights1.0.0/ && $(COPY_FILE) --parents main.cpp main_window.cpp .tmp/lights1.0.0/ && (cd `dirname .tmp/lights1.0.0` && $(TAR) lights1.0.0.tar lights1.0.0 && $(COMPRESS) lights1.0.0.tar) && $(MOVE) `dirname .tmp/lights1.0.0`/lights1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lights1.0.0
